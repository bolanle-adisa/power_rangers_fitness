...
public class prDatabaseC {
    String url = "jdbc:postgresql://localhost:5432/prDatabase";
    String user = "postgres";
    String password = "@Mudiaga6718";
    
    //get connection
    public Connection connectToprDB(){
        try{
           Class.forName("org.postgresql.Driver");
           String database = "jdbc:postgresql://localhost:5432/prDatabase";
           Connection con = DriverManager.getConnection(database, "postgres", "@Mudiaga6718");
